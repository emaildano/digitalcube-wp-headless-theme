...
if ( ! function_exists( 'susty_setup' ) ) :
	...
	function susty_setup() {
		...
		register_nav_menus( array(
			'shifter-primary'   => esc_html__( 'Shifter Primary', 'susty' ),
			'shifter-secondary' => esc_html__( 'Shifter Secondary', 'susty' ),
			'shifter-resources' => esc_html__( 'Shifter Resources', 'susty' ),
			'shifter-solutions' => esc_html__( 'Shifter Solutions', 'susty' ),
			'shifter-footer'    => esc_html__( 'Shifter Footer', 'susty' ),
		) );
